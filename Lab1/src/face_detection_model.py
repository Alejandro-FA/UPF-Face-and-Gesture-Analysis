...
class FaceDetectionModel:
    ...
    def detect_faces(self, image) -> list[tuple[int, int, int, int]]:
        ...
        for box in self.detect_elements(self.profile_lbpcascade, base_image):
            ...
            if len(eyes) > 0:
                # print(f"{self.img_count}: Checkpoint 1. profile and eyes detected")
        ...
        for box in faces:
            ...
            if len(haar_faces) > 0:
                ...
                # print(f"{self.img_count}: Checkpoint 2. lbp cascade and haar face detected")
            ...
            # If not, try to find other human elements
                ...
                len(self.detect_elements(self.nose_cascade, smileROI, scaleFactor=1.05)) > 0:
                    ...
                    # print(f"{self.img_count}: Checkpoint 3. lbp cascade and some other elements")
            ...
            for frame, angle in rotated_images:
                ...
                for curr_face in rotated_faces:
                    ...
                    len(self.detect_elements(self.profile_lbpcascade, rotated_face_ROI, scaleFactor=1.05)) > 0:
                        # print(f"{self.img_count}: Checkpoint 4. rotation added")
                        results.append(curr_face.get_coords())
                        face_added = True
                if face_added:
                    break
