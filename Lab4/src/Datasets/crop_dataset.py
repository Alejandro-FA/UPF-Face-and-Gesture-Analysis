...
class FaceCropper:
    ...
    def __init__(self, face_detector: frp.FaceDetector, preprocessor: frp.FaceDetectorPreprocessor, postprocessor: frp.FeatureExtractorPreprocessor, max_faces_per_image: int = 1, log_warnings=True, batch_size=128):
